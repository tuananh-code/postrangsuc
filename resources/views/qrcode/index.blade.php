...
<section class="content">
            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="tab_1">
                        <div class="row">
                            <div class="col-md-12">
                                <h4>Tất cả mẫu Qr <button type="button" class="btn btn-primary btn-modal pull-right" data-href="{{action('QrcodeController@create')}}" data-container=".Qrcode_modal">
    ...
    <div class="modal fade Qrcode_modal" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel">
    </div>
