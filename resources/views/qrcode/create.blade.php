<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    {!! Form::open(['url' => action('QrcodeController@store'), 'method' => 'post', 'id' => 'Qrcode_add_form' ]) !!}
    ...
    <div class="modal-body">
      <div class="row">
        ...
        <div class="col-sm-12">
          <div class="form-group">
            {!! Form::label('name', 'Ngân hàng' . ':*') !!}
            {!! Form::select('banks', [], null, ['class' => 'form-control', 'placeholder' => __('messages.please_select'), 'required', 'id' => 'banks']); !!}
          </div>
        </div>
        <div class="col-sm-12">
          <div class="form-group">
            {!! Form::label('name', 'Số tài khoản' . ':*') !!}
