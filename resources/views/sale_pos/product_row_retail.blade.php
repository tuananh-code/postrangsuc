...
<tr class="product_row" data-row_index="{{$row_count}}" @if(!empty($so_line)) data-so_id="{{$so_line->transaction_id}}" @endif>
	...
	<td class="text-center">
		<input type="number" name="products[{{$row_count}}][weight]" class="weight form-control" value="{{$product->weight}}">
		<span class="weight hide">{{@num_format($product->weight)}}</span>
	</td>
	<td class="text-center">
		<input type="number" name="products[{{$row_count}}][seed_weight]" class="seed_weight form-control" value="{{$product->seed_weight}}">
		<span class="seed_weight hide">{{@num_format($product->seed_weight)}}</span>
	</td>
	<td class="text-center">
		<input type="hidden" class="goden_weight" value="{{$product->weight - $product->seed_weight}}">
		<span class="goden_weight">{{@num_format($product->weight - $product->seed_weight)}}</span>
	</td>
	<td class="text-center">
	...
	<td class="text-center">
		<input type="number" name="products[{{$row_count}}][price]" class="price form-control" value="0">
	</td>
	<td class="text-center">
		@php
	...
	<td class="text-center">
		...
		@endphp
		<input type="{{$subtotal_type}}" name="products[{{$row_count}}][pos_line_total]" class="form-control pos_line_total @if(!empty($pos_settings['is_pos_subtotal_editable'])) input_number @endif" value="{{$product->quantity_ordered*$unit_price_inc_tax}}">
