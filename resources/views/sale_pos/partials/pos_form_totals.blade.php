	...
	<div class="col-md-12">
		<table class="table table-condensed">
			<tr>
				...
				<td><b>Mặt hàng mua:</b>&nbsp;
					<span id="total_quantity_buy">0</span>
				</td>
				<td>
					<b>Tổng bán</b> &nbsp;
					<span class="price_total">0</span>
					<input type="hidden" name="price_total" class="price_total">
				</td>
				<td>
					<b>Tổng mua</b> &nbsp;
					<span class="price_total_buy">0</span>
					<input type="hidden" name="price_total_buy" class="price_total_buy" value="0">
				</td>
			</tr>
			<tr>
				<td>
