...
<tr class="product_row" data-row_index="{{$row_count}}" @if(!empty($so_line)) data-so_id="{{$so_line->transaction_id}}" @endif>
	...
	<td class="text-center">
		<input type="hidden" name="products[{{$row_count}}][weight]" class="weight" value="{{@num_format($product->weight)}}">
		<span class="weight">{{@num_format($product->weight)}}</span>
	</td>
	<td class="text-center">
		<input type="hidden" name="products[{{$row_count}}][seed_weight]" class="seed_weight" value="{{@num_format($product->seed_weight)}}">
		<span class="seed_weight">{{@num_format($product->seed_weight)}}</span>
	</td>
	<td class="text-center">
		<input type="hidden" class="goden_weight" value="{{@num_format($product->weight - $product->seed_weight)}}">
		<span class="goden_weight">{{@num_format($product->weight - $product->seed_weight)}}</span>
	</td>
	<td class="text-center">
		<input type="hidden" name="products[{{$row_count}}][golden_age]" class="golden_age" value="{{@num_format($product->golden_age)}}">
		<span class="">{{$product->golden_age}}</span>
	</td>
	<td class="text-center">
		<input type="hidden" class='convert' class="" value="">
		<span class="convert_span"></span>
	</td>
	<td class="text-center">
		@php
