...
<tr class="product_row" data-row_index="{{$row_count}}" @if(!empty($so_line)) data-so_id="{{$so_line->transaction_id}}" @endif>
	...
	<td class="text-center">
		<input type="number" name="products[{{$row_count}}][weight]" class="weight form-control" value="{{$product->total_weight}}">
		<span class="weight hide">{{$product->total_weight}}</span>
	</td>
	<td class="text-center">
		<input type="number" name="products[{{$row_count}}][seed_weight]" class="seed_weight form-control" value="{{$product->weight_seed}}">
		<span class="seed_weight hide">{{$product->weight_seed}}</span>
	</td>
	<td class="text-center">
		<input type="hidden" class="goden_weight" value="{{$product->weight - $product->seed_weight}}">
		<span class="goden_weight">{{$product->total_weight - $product->weight_seed}}</span>
	</td>
	<td class="text-center">
		<input type="hidden" name="products[{{$row_count}}][golden_age]" class="golden_age" value="{{$product->golden_age}}">
		<span class="">{{$product->golden_age}}</span>
	</td>
	<td class="text-center">
		<input type="number" name="products[{{$row_count}}][price]" class="price form-control" value="{{$product->price}}">
	</td>
	<td class="text-center">
		@php
		...
		@endphp
		<input type="{{$subtotal_type}}" name="products[{{$row_count}}][pos_line_money]" class="form-control pos_line_money @if(!empty($pos_settings['is_pos_subtotal_editable'])) input_number @endif" value="{{$product->quantity_ordered*$unit_price_inc_tax}}">
		<span class="display_currency pos_line_money_text @if(!empty($pos_settings['is_pos_subtotal_editable'])) hide @endif" data-currency_symbol="true">{{$product->quantity_ordered*$unit_price_inc_tax}}</span>
	</td>
	<td class="text-center">
		@php
		$subtotal_type = !empty($pos_settings['is_pos_subtotal_editable']) ? 'text' : 'hidden';
		...
		@endphp
		<input type="{{$subtotal_type}}" name="products[{{$row_count}}][pos_line_total]" class="form-control pos_line_total @if(!empty($pos_settings['is_pos_subtotal_editable'])) input_number @endif" value="{{($product->total_weight - $product->weight_seed)*$product->price/100 + $product->quantity_ordered*$unit_price_inc_tax}}">
		<span class="display_currency pos_line_total_text @if(!empty($pos_settings['is_pos_subtotal_editable'])) hide @endif" data-currency_symbol="true">{{($product->total_weight - $product->weight_seed)*$product->price/100 + $product->quantity_ordered*$unit_price_inc_tax}}</span>
	</td>
