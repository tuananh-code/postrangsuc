...
<div class="form-group col-md-3">
    ...
    {!! Form::select('banks', [], null, ['class' => 'form-control', 'placeholder' => !empty($bank_details['bank_name']) ? $bank_details['bank_name'] :__('messages.please_select'), 'required', 'id' => 'banks']); !!}
    {!! Form::hidden('bank_details[bank_name]', !empty($bank_details['bank_name']) ? $bank_details['bank_name'] : null, ['class' => 'form-control', 'id' => 'bank_name', 'placeholder' => __( 'lang_v1.bank_name') ]); !!}
</div>
<div class="form-group col-md-3">
...
<script src="{{ asset('dist/bundle.js?v=' . $asset_v) }}"></script>