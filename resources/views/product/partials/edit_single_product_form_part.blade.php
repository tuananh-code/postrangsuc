  ...
  <div class="table-responsive">
    <table class="table table-bordered add-product-price-table table-condensed {{$class}}">
      <tr>
        ...
        <th class="hide">@lang('product.default_selling_price')</th>
      ...
      <tr>
        <td>
          ...
          <div class="col-sm-12">
            ...
            <label for="single_dpp">Giá sản phẩm:*</label>
            {!! Form::text('single_dpp', number_format($variation->default_purchase_price, 0, '', ','), ['class' => 'form-control input-sm dpp input_number', 'placeholder' => __('product.exc_of_tax'), 'required']); !!}
          </div>
