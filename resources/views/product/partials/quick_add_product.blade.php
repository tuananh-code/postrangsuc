      ...
      <div class="row">
        ...
        <div class="col-sm-4">
          <div class="form-group">
            ...
            {!! Form::select('category_id', $categories, 1, ['class' => 'form-control select2']); !!}
          </div>
        </div>
        ...
        <div class="col-sm-4">
          <div class="form-group">
            ...
            {!! Form::text('weight', !empty($duplicate_product->weight) ? $duplicate_product->weight : null, ['class' => 'form-control', 'placeholder' => __('lang_v1.total_weight'),'required' => 'true']); !!}
          </div>
        </div>
        <div class="col-sm-4">
          <div class="form-group">
