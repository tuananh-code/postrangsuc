    ...
    <tr>
      <td>
        <div class="col-sm-6">
          ...
          <label for="single_dpp">Giá sản phẩm(tiền công):*</label>
          <!-- {!! Form::text('single_dpp', $default, ['class' => 'form-control input-sm dpp input_number', 'placeholder' => __('product.exc_of_tax'), 'required']); !!} -->
          {!! Form::text('single_dpp', $default, ['class' => 'form-control input-sm dpp input_number', 'placeholder' => 'Giá sản phẩm', 'required']); !!}
        </div>
