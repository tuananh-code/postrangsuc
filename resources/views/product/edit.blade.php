  ...
  <div class="row">
    ...
    <div class="col-sm-4">
      <div class="form-group">
        ...
        {!! Form::text('weight', $product->weight, ['class' => 'form-control', 'placeholder' => __('lang_v1.weight'), 'required' => true]) !!}
      </div>
    </div>
    <div class="col-sm-4">
      <div class="form-group">
        {!! Form::label('seed_weight', __('lang_v1.seed_weight') . ':') !!}
        {!! Form::text('seed_weight', $product->seed_weight, ['class' => 'form-control', 'placeholder' => __('lang_v1.seed_weight')]); !!}
      </div>
    </div>
    <div class="col-sm-4" id='category_golden'>
      <div class="form-group">
        {!! Form::label('golden_age', __('lang_v1.golden_age') . ':') !!}
        {!! Form::text('golden_age', $product->golden_age, ['class' => 'form-control', 'placeholder' => __('lang_v1.golden_age')]); !!}
      </div>
    </div>
    <div class="col-sm-4">
      <div class="form-group">
    ...
    <div class="col-sm-4" id="alert_quantity_div" @if(!$product->enable_stock) style="display:none" @endif>
      <div class="form-group">
        ...
        {!! Form::number('alert_quantity', intval($product->alert_quantity), ['class' => 'form-control',
