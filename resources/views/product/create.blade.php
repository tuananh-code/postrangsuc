  ...
  <div class="row">
    ...
    <div class="col-sm-4 @if(!session('business.enable_category')) hide @endif">
      <div class="form-group">
        ...
        {!! Form::select('category_id', $categories, !empty($duplicate_product->category_id) ? $duplicate_product->category_id : 1, ['class' => 'form-control select2']) !!}
      </div>
    </div>
    ...
    <div class="col-sm-4">
      <div class="form-group">
        {!! Form::label('weight', __('lang_v1.total_weight') . ':') !!}
        {!! Form::text('weight', !empty($duplicate_product->weight) ? $duplicate_product->weight : null, ['class' => 'form-control required', 'placeholder' => __('lang_v1.total_weight')]); !!}
      </div>
    </div>
    <div class="col-sm-4">
      <div class="form-group">
        {!! Form::label('seed_weight', __('lang_v1.seed_weight') . ':') !!}
        {!! Form::text('seed_weight', !empty($duplicate_product->seed_weight) ? $duplicate_product->seed_weight : null, ['class' => 'form-control', 'placeholder' => __('lang_v1.seed_weight')]); !!}
      </div>
    </div>
    <div class="col-sm-4" id='category_golden'>
      <div class="form-group">
        {!! Form::label('golden_age', __('lang_v1.golden_age') . ':') !!}
        {!! Form::text('golden_age', !empty($duplicate_product->golden_age) ? $duplicate_product->golden_age : null, ['class' => 'form-control', 'placeholder' => __('lang_v1.golden_age')]); !!}
      </div>
    </div>
    @php
    ...
    <div class="col-md-12 text-center">
      <button type="button" class="btn btn-primary btn-sm" id="toggle_extend"> <i class="fas fa-plus"></i>
        Ẩn/hiện mở rộng <i class="fas fa-chevron-down"></i></button>
    </div>
    <div class="clearfix"></div>
    <div class="extend box box-solid">
      <div class="col-sm-8">
        <div class="form-group">
