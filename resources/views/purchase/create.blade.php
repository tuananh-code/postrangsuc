...
<section class="content">
	...
	<div class="row">
		...
		<div class="col-sm-3">
			<div class="form-group">
				{!! Form::label('location_id2', __('purchase.business_location').':*') !!}
				@show_tooltip(__('tooltip.purchase_location'))
				{!! Form::select('location_id2', $business_locations, $default_location, ['class' => 'form-control select2', 'placeholder' => __('messages.please_select'), 'required'], $bl_attributes); !!}
			</div>
		</div>
...
<script type="text/javascript">
	...
	$(document).on('change', '.payment_types_dropdown, #location_id2', function(e) {
		var default_accounts = $('select#location_id2').length ?
			$('select#location_id2')
			.find(':selected')
