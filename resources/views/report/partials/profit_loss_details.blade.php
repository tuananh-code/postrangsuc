...
<div class="col-xs-4">
    ...
    <table class="table table-striped">
        <tr>
            <th>Đơn giá trao đổi:<br><small class="text-muted">(@lang('product.exc_of_tax'), @lang('sale.discount'))</small></th>
            <td>
                <span class="display_currency" data-currency_symbol="true">{{$data['total_buysell']}}</span>
            </td>
        </tr>
        <tr>
            <th>{{ __('lang_v1.total_transfer_shipping_charge') }}:</th>
            <td>
                <span class="display_currency" data-currency_symbol="true">{{$data['total_buysell_shipping_charge']}}</span>
            </td>
        </tr>
        <tr>
            <th>Tổng chiết khấu trao đổi:</th>
            <td>
                <span class="display_currency" data-currency_symbol="true">{{$data['total_buysell_discount']}}</span>
            </td>
        </tr>
        @foreach($data['left_side_module_data'] as $module_data)
        <tr>
