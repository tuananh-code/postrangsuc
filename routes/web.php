...
Route::middleware(['setData'])->group(function () {
    ...
    Route::get('/quote/{token}', 'SellPosController@showInvoice')
        ->name('show_quote');
    Route::get('bill/invoice/{token}', 'BuySellPosController@showInvoice')
    ->name('show_invoice_buysell');
    Route::get('bill/quote/{token}', 'BuySellPosController@showInvoice')
    ->name('show_quote_buysell');
});
...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::get('/home/get-totals', 'HomeController@getTotals');
        // Test, Put your code to get view you create from controller here
    Route::get('/reportform/pnj', 'ReportFormController@getReportFormPnj')->name('pnjform');
    Route::get('/reportform/sjc', 'ReportFormController@getReportFormSjc')->name('sjcform');
    Route::get('/reportform/doji', 'ReportFormController@getReportFormDoji')->name('dojiform');

    // Set all basic method for Controller to use for push data in Controller
    // Route::resource('test', 'TestController');
    // Get template website
    Route::get('/template/pnj', 'TemplateController@getPnjTemplate')->name('pnj.template');
    Route::get('/template/pnj/product/{id}', 'TemplateController@getProduct')->name('product.template');
    Route::get('/template/pnj/checkout/{id}', 'TemplateController@checkout')->name('checkout.template');
    Route::post('/send_mail/{id}', 'SendMailController@send_mail')->name('sendmail.mail');
    Route::get('/template/sjc', 'TemplateController@getSjcTemplate')->name('sjc.template');
    Route::get('/template/doji', 'TemplateController@getDojiTemplate')->name('doji.template');
    ...
    Route::get('/buysell/get_products_buy', 'BuySellController@getProductsBuy');
    Route::get('/buysell/get_products_sell', 'BuySellController@getProductsSell');
    Route::post('/buysell/pos/get-types-of-service-details', 'BuySellPosController@getTypesOfServiceDetails');
    Route::get('/buysell/get_suppliers', 'BuySellController@getSuppliers');
    Route::get('/buysell/duplicate/{id}', 'BuySellController@duplicateSell');
    Route::get('/buysell/drafts', 'BuySellController@getDrafts');
    ...
    Route::resource('BuySellPos', 'BuySellPosController');
    ...
    Route::get('/buysell/pos/get_product_row/{variation_id}/{location_id}', 'BuySellPosController@getProductRow');
    ...
    Route::get('/buysell/pos/get-recent-transactions', 'BuySellPosController@getRecentTransactions');
    ...
    //BuySell return
    Route::resource('buysell-return', 'BuySellReturnController');
    Route::get('buysell-return/get-product-row', 'BuySellReturnController@getProductRow');
    Route::get('/buysell-return/print/{id}', 'BuySellReturnController@printInvoice');
    Route::get('/buysell-return/add/{id}', 'BuySellReturnController@add');
    ...
    Route::get('buysells/edit-shipping/{id}', 'BuySellController@editShipping');
    Route::put('buysells/update-shipping/{id}', 'BuySellController@updateShipping');
    ...
    Route::get('view-media/{model_id}/buysell', 'BuySellController@viewMedia');
...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone'])->group(function () {
    ...
    Route::get('/buysell/invoice-url/{id}', 'BuySellPosController@showInvoiceUrl');
